    ...
    : IClassFixture<MailerMetricsFixture>, IAsyncLifetime
{
    ...
    public async Task Metrics_includes_required_metric_names()
    {
        ...
        Assert.Contains("mail_provider_queue_payload_invalid_total", body, StringComparison.Ordinal);
        Assert.Contains("mail_provider_queue_poisoned_total", body, StringComparison.Ordinal);
    ...
    public async Task Metrics_webhook_values_match_db_stats()
    {
        ...
        Assert.Contains("# TYPE mail_provider_queue_payload_invalid_total counter", body, StringComparison.Ordinal);
        Assert.Contains("# TYPE mail_provider_queue_poisoned_total counter", body, StringComparison.Ordinal);
