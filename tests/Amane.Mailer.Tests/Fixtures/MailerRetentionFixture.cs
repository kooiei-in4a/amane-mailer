...
public sealed class MailerRetentionFixture() : MailerWebApplicationFixtureBase(workerEnabled: true)
{
    ...
    protected override IReadOnlyDictionary<string, string?> ExtraConfiguration =>
        new Dictionary<string, string?>
        {
            ...
            ["Mailer:Retention:Days"] = "90",
            ["Mailer:Retention:SweepIntervalSeconds"] = "1",
        };
