...
| `admin google unlink --username <name>` | Delete that Admin's Google identity mapping and revoke their active `admin_sessions`. Does not print Google subject or email | 0=success / 1=schema unavailable / 2=usage error / 3=not found / 130=cancelled |
