...
公開済み GHCR ランタイムイメージ（現在公開中の例: `ghcr.io/kooiei-in4a/amane-mailer:v2.3.1`）を
...
`v2.3.1` の value-free smoke 結果（digest、日付、環境、各 check の pass/fail）は
[docs/releases/v2.3.1.md](../releases/v2.3.1.md) に記録します。過去の `v1.2.0` 結果は
