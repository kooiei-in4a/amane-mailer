...
After v1.0.1 is published, this runbook pulls the GHCR runtime image (default
`ghcr.io/kooiei-in4a/amane-mailer:v1.0.1`) from a clean state, starts Mailer +
...
| `MAILER_IMAGE_TAG` | `v1.0.1` | Tag under test |
...
Value-free smoke results for `v1.0.1` (digest, date, environment, per-check pass/fail)
are recorded in [docs/releases/v1.0.1.md](../releases/v1.0.1.md) after publish.
Previous `v1.0.0` results remain in [docs/releases/v1.0.0.md](../releases/v1.0.0.md),
and `v0.9.2` results in [docs/releases/v0.9.2.md](../releases/v0.9.2.md).
