...
After v1.3.0 is published, this runbook pulls the GHCR runtime image (default
`ghcr.io/kooiei-in4a/amane-mailer:v1.3.0`) from a clean state, starts Mailer +
...
| `MAILER_IMAGE_TAG` | `v1.3.0` | Tag under test |
...
Value-free smoke results for `v1.3.0` (digest, date, environment, per-check pass/fail)
are recorded in [docs/releases/v1.3.0.md](../releases/v1.3.0.md).
Previous `v1.2.0` results remain in [docs/releases/v1.2.0.md](../releases/v1.2.0.md),
and previous `v1.1.0` results remain in [docs/releases/v1.1.0.md](../releases/v1.1.0.md).
