...
After v1.3.4 is published, this runbook pulls the GHCR runtime image (default
`ghcr.io/kooiei-in4a/amane-mailer:v1.3.4`) from a clean state, starts Mailer +
...
- For v1.3.4, the default smoke tag is `v1.3.4` and the runtime image is
...
| `MAILER_IMAGE_TAG` | `v1.3.4` | Tag under test |
