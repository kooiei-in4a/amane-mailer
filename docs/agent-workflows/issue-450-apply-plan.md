...
> **Status:** Approved plan authority for the #450 implementation PR (`issue/450-bundle-apply-rollback`).
...
> **Supersedes plan-only handoff PR:** [#468](https://github.com/kooiei-in4a/amane-mailer/pull/468)

This document is the approved implementation plan for [#450](https://github.com/kooiei-in4a/amane-mailer/issues/450).
Implementation lives on `issue/450-bundle-apply-rollback` from latest `develop`, not on the plan handoff branch.
