...
- Git tag `v2.0.0`: **NOT YET PUBLISHED**
- Git tag target: **PENDING**
- annotated tag object: **PENDING**
- GHCR `ghcr.io/kooiei-in4a/amane-mailer:v2.0.0`: **NOT YET PUBLISHED**
...
- NuGet `Amane.Mailer.Contracts 2.0.0`: **NOT YET PUBLISHED**
...
- `latest == v2.0.0` by OCI digest: **PENDING**
