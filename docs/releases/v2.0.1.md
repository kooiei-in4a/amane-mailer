...
v2.0.1 is planned as a full service release. Public artifact identities are
not recorded until they are observed after publication.

Version preparation updates Contracts and OpenAPI to `2.0.1` and creates this
...
- `src/Amane.Mailer.Contracts/Amane.Mailer.Contracts.csproj`: `2.0.1`
- `docs/api/openapi.yaml` `info.version`: `2.0.1`
- `CHANGELOG.md`: reviewed `## [2.0.1]` entry required before Version Preparation acceptance
...
- Git tag `v2.0.1`: **NOT YET PUBLISHED**
- Git tag target: **PENDING**
- annotated tag object: **PENDING**
- GHCR `ghcr.io/kooiei-in4a/amane-mailer:v2.0.1`: **NOT YET PUBLISHED**
...
- NuGet `Amane.Mailer.Contracts 2.0.1`: **NOT YET PUBLISHED**
...
- GitHub Release `v2.0.1`: **NOT YET PUBLISHED**
