...
v1.3.7 is planned as a full service release. Public artifact identities are
not recorded until they are observed after publication.

Version preparation updates Contracts and OpenAPI to `1.3.7` and creates this
...
- Git tag `v1.3.7`: **NOT YET PUBLISHED**
- Git tag target: **PENDING**
- annotated tag object: **PENDING**
- GHCR `ghcr.io/kooiei-in4a/amane-mailer:v1.3.7`: **NOT YET PUBLISHED**
...
- NuGet `Amane.Mailer.Contracts 1.3.7`: **NOT YET PUBLISHED**
...
- GitHub Release `v1.3.7`: **NOT YET PUBLISHED**
...
- `latest == v1.3.7` by OCI digest: **PENDING**
