...
.DESCRIPTION
  Pulls ghcr.io/kooiei-in4a/amane-mailer:v0.9.2, starts Mailer + Mailpit from a
  ...
  Config via environment (all optional):
    ...
    MAILER_IMAGE_TAG         default v0.9.2
...
$env:MAILER_IMAGE_TAG = Get-EnvOrDefault 'MAILER_IMAGE_TAG' 'v0.9.2'
