...
.DESCRIPTION
  Pulls ghcr.io/kooiei-in4a/amane-mailer:v1.3.0, starts Mailer + Mailpit from a
  ...
  Config via environment (all optional):
    ...
    MAILER_IMAGE_TAG         default v1.3.0
...
$env:MAILER_IMAGE_TAG = Get-EnvOrDefault 'MAILER_IMAGE_TAG' 'v1.3.0'
