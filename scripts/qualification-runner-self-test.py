...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="qualification-runner-self-test-") as temp:
        ...
        for label, unsafe_path, expected_message in (
            ...
            ("backslash base scope path", "nested\\v1.3.0-scope.json", "unsafe baseScope.manifestPath"),
            ("NTFS alternate data stream base path", "scope-manifest.json:base", "unsafe baseScope.manifestPath"),
            ("leading-dot segment base scope path", "./v1.3.0-scope.json", "unsafe baseScope.manifestPath"),
            ("trailing-empty segment base scope path", "v1.3.0-scope.json/", "unsafe baseScope.manifestPath"),
            ("double-separator base scope path", "nested//v1.3.0-scope.json", "unsafe baseScope.manifestPath"),
            ("intermediate-dot segment base scope path", "nested/./v1.3.0-scope.json", "unsafe baseScope.manifestPath"),
            ("parent segment base scope path", "nested/../v1.3.0-scope.json", "unsafe baseScope.manifestPath"),
        ...
        hard_positive = {
            ...
            "G456-20": {"fault": "fingerprint-mismatch", "fingerprintMismatchDetected": True, "verificationResult": "rejected", "activationResult": "blocked", "staleState": "activated", "bundleIntegrityMatched": True, "sensitiveOutput": "absent"},
