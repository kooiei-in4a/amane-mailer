...
After v2.0.2 is published, smoke the GHCR image (default `ghcr.io/kooiei-in4a/amane-mailer:v2.0.2`)
...
[v2.0.2 release record](docs/releases/v2.0.2.md) /
[GitHub Release](https://github.com/kooiei-in4a/amane-mailer/releases/tag/v2.0.2).

The v2.0.2 GHCR runtime image is **`linux/amd64` only**.
The current public release tag is `v2.0.2`, but release smoke requires an explicit
