...
- Unlink a Google identity with `admin google unlink --username <name>` (do not edit SQLite directly)
...
Smoke the published GHCR image (default `ghcr.io/kooiei-in4a/amane-mailer:v2.3.1`)
...
[v2.3.1 release record](docs/releases/v2.3.1.md) /
[GitHub Release](https://github.com/kooiei-in4a/amane-mailer/releases/tag/v2.3.1).

The v2.3.1 GHCR runtime image is **`linux/amd64` only**.
The current public release tag is `v2.3.1`, but release smoke requires an explicit
