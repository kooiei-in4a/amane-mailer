...
[v2.1.0 release record](docs/releases/v2.1.0.md) /
[GitHub Release](https://github.com/kooiei-in4a/amane-mailer/releases/tag/v2.1.0).

The v2.1.0 GHCR runtime image is **`linux/amd64` only**.
The current public release tag is `v2.1.0`, but release smoke requires an explicit
