...
// a non-empty array is re-projected to exactly file_name (NFC), content_type, byte_length,
// content_sha256, and a zero-based order generated from array position -- never the raw
